...
class Config:
    ...
    TYPING_TYPO_PROBABILITY: float = 0.02  # Chance of a typo per character
    TYPING_ERROR_DELAY_SECONDS: float = 0.5  # Delay before correcting a typo
    ...
    VIDEO_CRF: int = int(
        os.getenv("VIDEO_CRF", "18")
    )  # High quality, smaller than lossless
    VIDEO_PRESET: str = os.getenv(
        "VIDEO_PRESET", "medium"
    ...
    def get_available_fonts(cls) -> dict:
        ...
        system_fonts = {
            ...
            "monaco": {"name": "Monaco", "path": None, "type": "system"},  # System font
        }
